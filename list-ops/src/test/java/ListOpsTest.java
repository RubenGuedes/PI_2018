...
public class ListOpsTest {
	...
	public void testAppendingEmptyLists() {
		assertEquals(Collections.emptyList(), ListOps.append(Collections.emptyList(), Collections.emptyList()));
	}
	...
	public void testFilteringNonEmptyList() {
		assertEquals(Arrays.asList(1, 3, 5), ListOps.filter(Arrays.asList(1, 2, 3, 5), integer -> integer % 2 == 1));
	}
	...
	public void testTransformingEmptyList() {
		assertEquals(Collections.emptyList(), ListOps.map(Collections.<Integer>emptyList(), integer -> integer + 1));
	}

	@Test
	public void testTransformingNonEmptyList() {
		assertEquals(Arrays.asList(2, 4, 6, 8), ListOps.map(Arrays.asList(1, 3, 5, 7), integer -> integer + 1));
	}
	...
	public void testReversingEmptyList() {
		assertEquals(Collections.emptyList(), ListOps.reverse(Collections.emptyList()));
	}
